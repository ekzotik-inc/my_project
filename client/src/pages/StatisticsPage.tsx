...
const achievementArt = achievementIds.reduce((art, id) => {
  art[id] = `https://github.com/ekzotik-inc/my_project/releases/download/achievement-stickers-v4/${id}.png`;
  return art;
